$(function () {
    ...
    function ceshis1() {
        ...
        var xdata = ['欧盟', "日本", "意大利", "英国", "俄罗斯", "新加坡", "马来西亚", "菲律宾", "巴西", "阿根廷"];
    ...
    function ceshis2() {
        ...
        option = {
            ...
            "legend": {
                ...
                "padding": [15, 20],
                "itemGap": 5,
                "data": ["欧盟", "日本", "意大利", "英国", "俄罗斯", "新加坡", "马来西亚", "菲律宾","巴西","阿根廷"]
            },
            "series": [{
                "type": "pie",
                "center": ["50%", "40%"],
    ...
    function ceshis3() {
        ...
        option = {
            ...
            series: [{
                name: '下单量',
                type: 'bar',
                data: [212.0, 234.9,227.0, 223.2, 225.6, 376.7, 335.6, 362.2, 232.6, 220.0, 236.4, 233.3],
                itemStyle: {
                    normal: {
                        barBorderRadius: 2
                    }
            ...
            },
                {
                    ...
                    type: 'bar',
                    yAxisIndex: 1,
                    data: [222.6, 235.9, 239.0, 226.4, 328.7, 370.7, 375.6, 382.2, 348.7, 318.8, 356.0, 342.3],
                    itemStyle: {
                        normal: {
                            barBorderRadius: 2
                        }
                ...
                },
                {
                    ...
                    type: 'line',
                    yAxisIndex: 2,
                    data: [18.0, 22.2, 23.3, 24.5, 26.3, 28.2, 28.3, 23.4, 23.0, 26.5, 22.0, 26.2],
                }
            ]
        };
        // 使用刚指定的配置项和数据显示图表。
